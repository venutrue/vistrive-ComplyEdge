...
1. `references/Code on Wages 2019.pdf`
2. `references/Code On Wages.pdf`
3. `references/Rules_Draft Code on Wages.pdf`
4. `references/Code on Social Security 2020.pdf`
5. `references/Rules_Social Security Code.pdf`
6. `references/Industrial Relations Code.pdf`
7. `references/Rules_Draft Industrial Relations Code.pdf`
8. `references/Occupational Safety Health and Working Conditions Code 2020.pdf`
9. `references/Rules_Draft Occupational Safety Health and Working Conditions Code 2020.pdf`

### Secondary explainers / practitioner references
10. `references/Key Provisions under Social Security.pdf`
11. `references/Booklet New Labour Code India.pdf`
12. `references/Compliance Handbook for Employers.pdf`
